    ...
    return (
        <div className='flex flex-col md:flex-row md:justify-between items-center w-11/12 mx-auto py-10' >
            ...
            <div className='space-y-4 w-full md:w-1/2'>
                ...
                <button className='flex items-center gap-2 px-4 py-2 rounded-full border border-[#9514FA] bg-[#F3EEFF] text-[#6B21A8] text-sm font-medium transition-all md:hover:scale-105 duration-500'>
                    <span className='w-2 h-2 rounded-full bg-[#9514FA] inline-block'></span>
                ...
                <div className='flex  items-center text-center gap-4' >
                    ...
                    <button className="btn btn-sm md:btn-md bg-linear-to-r from-[#4F39F6] to-[#9514FA] text-white rounded-full md:hover:scale-105 duration-500 transition-all  ease-in-out ">Explore Products</button>

                    <button className="btn btn-sm md:btn-md font-semibold rounded-full border-[#4F39F6]
            ...
            <div className='mt-6 md:mt-0 w-full md:w-5/12 flex justify-center'>
                <img
                    className='rounded-3xl w-96 md:w-full h-auto object-contain transition-all md:hover:scale-105 duration-500'
                    src={banner}
                    alt="Banner"
                />
            </div>
