        ...
        <nav className=' bg-white border-b border-gray-300 shadow-md'>
            ...
            <div className='flex justify-between items-center w-11/12 mx-auto py-4 z-50'>
                ...
                <div className='flex gap-2 md:gap-5 items-center'>
                    <GiShoppingCart className='cursor-pointer' size={20} />
                    <a className=' text-sm md:text-[16px] font-bold hover:text-blue-500 duration-500 cursor-pointer' href="#">Login</a>

                    <button className='btn btn-sm md:btn-md btn-primary cursor-pointer'>Get Started</button>
